...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(mealType) => "Tyto položky budou přidány do ${mealType}.";

  static String m3(count) => "Importovat ${count} položek?";

  static String m4(count) =>
      "${count} položek nebylo možné načíst z OpenFoodFacts.";

  static String m5(riskValue) => "Riziko komorbidit: ${riskValue}";

  static String m6(age) => "${age} let";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "importMealConfirmContent": m2,
        "importMealConfirmTitle": m3,
