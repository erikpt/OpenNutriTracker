...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(mealType) =>
      "Questi elementi verranno aggiunti a ${mealType}.";

  static String m3(count) => "Importare ${count} voci?";

  static String m4(count) =>
      "${count} elemento/i non è stato possibile recuperare da OpenFoodFacts.";

  static String m5(riskValue) => "Rischio di comorbilità: ${riskValue}";

  static String m6(age) => "${age} anni";
