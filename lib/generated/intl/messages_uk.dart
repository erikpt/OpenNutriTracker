...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(count) => "Import ${count} items?";

  static String m4(count) =>
      "${count} елемент(ів) не вдалося отримати з OpenFoodFacts.";

  static String m5(riskValue) => "Ризик супутніх захворювань: ${riskValue}";

  static String m6(age) => "${age} років";
