...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(versionNumber) => "Версія ${versionNumber}";

  static m1(pctCarbs, pctFats, pctProteins) => "${pctCarbs}% вуглеводи, ${pctFats}% жири, ${pctProteins}% білки";

  static m2(mealType) => "These items will be added to your ${mealType}.";

  static m3(count) => "Import ${count} items?";

  static m4(riskValue) => "Ризик супутніх захворювань: ${riskValue}";

  static m5(age) => "${age} років";

  @override
  final Map<String, dynamic> messages = _notInlinedMessages(_notInlinedMessages);

  static Map<String, dynamic> _notInlinedMessages(_) => {
      'activityExample': MessageLookupByLibrary.simpleMessage('наприклад, біг, їзда на велосипеді, йога ...'),
    ...
    'additionalInfoLabelCompendium2011': MessageLookupByLibrary.simpleMessage('Інформація надана\n \"2011 Compendium\n of Physical Activities\"'),
    'additionalInfoLabelCustom': MessageLookupByLibrary.simpleMessage('Власний елемент їжі'),
    'additionalInfoLabelFDC': MessageLookupByLibrary.simpleMessage('Більше інформації на\nFoodData Central'),
    'additionalInfoLabelOFF': MessageLookupByLibrary.simpleMessage('Більше інформації на\nOpenFoodFacts'),
    ...
    'appDescription': MessageLookupByLibrary.simpleMessage('OpenNutriTracker — це безкоштовний трекер калорій та поживних речовин з відкритим кодом, який поважає вашу конфіденційність і не містить реклами'),
    ...
    'bmiInfo': MessageLookupByLibrary.simpleMessage('Індекс маси тіла (ІМТ) — це індекс для класифікації надмірної ваги та ожиріння у дорослих. Визначається як вага в кілограмах, поділена на квадрат зросту в метрах (кг/м²). ІМТ не розрізняє жирову і м\'язову масу і може бути неточним для деяких людей.'),
    'bmiLabel': MessageLookupByLibrary.simpleMessage('ІМТ'),
    'breakfastExample': MessageLookupByLibrary.simpleMessage('наприклад, пластівці, молоко, кава ...'),
    ...
    'calculationsTDEEIOM2006Label': MessageLookupByLibrary.simpleMessage('Розрахунок Інституту Медицини'),
    ...
    'copyDialogTitle': MessageLookupByLibrary.simpleMessage('До якого типу страви скопіювати?'),
    'copyOrDeleteTimeDialogContent': MessageLookupByLibrary.simpleMessage('За допомогою \"Скопіювати на сьогодні\" ви можете скопіювати страву на сьогодні. За допомогою \"Видалити\" ви можете видалити страву.'),
    'copyOrDeleteTimeDialogTitle': MessageLookupByLibrary.simpleMessage('Що ви хочете зробити?'),
    'createCustomDialogContent': MessageLookupByLibrary.simpleMessage('Бажаєте створити власну їжу?'),
    ...
    'dataCollectionLabel': MessageLookupByLibrary.simpleMessage('Підтримайте розробку, надаючи анонімні дані про використання'),
    'deleteAllLabel': MessageLookupByLibrary.simpleMessage('Видалити все'),
    'deleteTimeDialogContent': MessageLookupByLibrary.simpleMessage('Ви хочете видалити вибраний елемент?'),
    'deleteTimeDialogPluralContent': MessageLookupByLibrary.simpleMessage('Ви хочете видалити всі елементи цієї страви?'),
    ...
    'dinnerExample': MessageLookupByLibrary.simpleMessage('наприклад, суп, курка, вино ...'),
    'dinnerLabel': MessageLookupByLibrary.simpleMessage('Вечеря'),
    'disclaimerText': MessageLookupByLibrary.simpleMessage('OpenNutriTracker не є медичним додатком. Всі надані дані не перевіряються і повинні використовуватися з обережністю. Будь ласка, ведіть здоровий спосіб життя і консультуйтеся з фахівцем, якщо у вас виникли проблеми. Використання під час хвороби, вагітності або лактації не рекомендується.'),
    ...
    'errorFetchingProductData': MessageLookupByLibrary.simpleMessage('Помилка при отриманні даних про продукт'),
    'errorLoadingActivities': MessageLookupByLibrary.simpleMessage('Помилка при завантаженні активностей'),
    'errorMealSave': MessageLookupByLibrary.simpleMessage('Помилка при збереженні страви. Ви ввели коректну інформацію?'),
    'errorOpeningBrowser': MessageLookupByLibrary.simpleMessage('Помилка при відкритті браузера'),
    'errorOpeningEmail': MessageLookupByLibrary.simpleMessage('Помилка при відкритті поштової програми'),
    ...
    'exportImportDescription': MessageLookupByLibrary.simpleMessage('Ви можете експортувати дані додатка у zip-файл і імпортувати їх пізніше. Це корисно, якщо ви хочете зробити резервну копію або перенести дані на інший пристрій. Додаток не використовує жодних хмарних сервісів для зберігання ваших даних.'),
    'exportImportErrorLabel': MessageLookupByLibrary.simpleMessage('Помилка експорту / імпорту'),
    'exportImportLabel': MessageLookupByLibrary.simpleMessage('Експорт / Імпорт даних'),
    ...
    'lunchExample': MessageLookupByLibrary.simpleMessage('наприклад, піца, салат, рис ...'),
    ...
    'mealSizeLabelImperial': MessageLookupByLibrary.simpleMessage('Розмір страви (унція/рідка унція)'),
    'mealUnitLabel': MessageLookupByLibrary.simpleMessage('Одиниця страви'),
    'milliliterUnit': MessageLookupByLibrary.simpleMessage('мл'),
    'missingProductInfo': MessageLookupByLibrary.simpleMessage('У продукту відсутня необхідна інформація про ккал або макроелементи'),
    'noActivityRecentlyAddedLabel': MessageLookupByLibrary.simpleMessage('Нещодавно не додано активності'),
    ...
    'nutritionalStatusRiskLow': MessageLookupByLibrary.simpleMessage('Низький (але ризик інших клінічних проблем підвищений)'),
    ...
    'offDisclaimer': MessageLookupByLibrary.simpleMessage('Дані, які надає цей додаток, отримані з бази даних Open Food Facts. Не гарантується точність, повнота або надійність наданої інформації. Дані надаються “як є”, і джерело даних (Open Food Facts) не несе відповідальності за будь-які збитки, що виникають внаслідок використання даних.'),
    'onboardingActivityQuestionSubtitle': MessageLookupByLibrary.simpleMessage('Наскільки ви активні? (без тренувань)'),
    ...
    'onboardingIntroDescription': MessageLookupByLibrary.simpleMessage('Для початку додаток потребує деяку інформацію про вас, щоб розрахувати вашу щоденну ціль калорій.\nВся інформація про вас зберігається безпечно на вашому пристрої.'),
    ...
    'onboardingSaveUserError': MessageLookupByLibrary.simpleMessage('Неправильне введення, спробуйте ще раз'),
    ...
    'paAmericanFootballGeneralDesc': MessageLookupByLibrary.simpleMessage('безконтактний, з прапорцями, загальний'),
    ...
    'paBadmintonGeneralDesc': MessageLookupByLibrary.simpleMessage('соціальний одиночний та парний розряд, загальний'),
    ...
    'paCalisthenicsGeneralDesc': MessageLookupByLibrary.simpleMessage('легкі або помірні зусилля, загальне (наприклад, вправи для спини)'),
    'paCanoeingGeneral': MessageLookupByLibrary.simpleMessage('веслування на каное'),
    'paCanoeingGeneralDesc': MessageLookupByLibrary.simpleMessage('веслування, для задоволення, загальне'),
    ...
    'paCheerleadingDesc': MessageLookupByLibrary.simpleMessage('гімнастичні рухи, змагальний'),
    'paChildrenGame': MessageLookupByLibrary.simpleMessage('дитячі ігри'),
    'paChildrenGameDesc': MessageLookupByLibrary.simpleMessage('(наприклад, класики, 4-квадрат, вишибали, ігровий майданчик, т-бол, tetherball, марбли, аркадні ігри), помірні зусилля'),
    'paClimbingHillsNoLoadGeneral': MessageLookupByLibrary.simpleMessage('підйом на пагорби, без навантаження'),
    ...
    'paCricketDesc': MessageLookupByLibrary.simpleMessage('відбивання, подача, гра в полі'),
    ...
    'paDancingGeneralDesc': MessageLookupByLibrary.simpleMessage('наприклад, диско, народні, ірландські, лінійні, полька, контра, кантрі'),
    ...
    'paDivingGeneralDesc': MessageLookupByLibrary.simpleMessage('підводне плавання, дайвінг з аквалангом, загальне'),
    ...
    'paLawnBowlingDesc': MessageLookupByLibrary.simpleMessage('бочче, на відкритому повітрі'),
    'paMartialArtsModerate': MessageLookupByLibrary.simpleMessage('бойові мистецтва'),
    'paMartialArtsModerateDesc': MessageLookupByLibrary.simpleMessage('різні види, помірний темп (наприклад, дзюдо, джиу-джитсу, карате, кікбоксинг, тхеквондо, тай-бо, муай-тай)'),
    'paMartialArtsSlower': MessageLookupByLibrary.simpleMessage('бойові мистецтва'),
    'paMartialArtsSlowerDesc': MessageLookupByLibrary.simpleMessage('різні види, повільний темп, для початківців, тренування'),
    'paMotoCross': MessageLookupByLibrary.simpleMessage('мотокрос'),
    'paMotoCrossDesc': MessageLookupByLibrary.simpleMessage('позашляхові мотоспорт, всюдихід, загальне'),
    ...
    'paResistanceTrainingDesc': MessageLookupByLibrary.simpleMessage('підняття ваги, вільна вага, Nautilus або Universal'),
    ...
    'paRopeJumpingGeneralDesc': MessageLookupByLibrary.simpleMessage('помірний темп, 100-120 стрибків/хв, загальне, стрибки на двох ногах, звичайний відскок'),
    ...
    'paSailingGeneralDesc': MessageLookupByLibrary.simpleMessage('вітрильний спорт на човні та дошці, віндсерфінг, вітрильний спорт на льоду, загальне'),
    ...
    'paSkydivingDesc': MessageLookupByLibrary.simpleMessage('скайдайвінг, бейс-джампінг, банджі-джампінг'),
    ...
    'paSnowShovingModerateDesc': MessageLookupByLibrary.simpleMessage('Розчишення снігу, помірні зусилля'),
    ...
    'paSoftballBaseballGeneralDesc': MessageLookupByLibrary.simpleMessage('швидка або повільна подача, загальне'),
    ...
    'paSurfingDesc': MessageLookupByLibrary.simpleMessage('бодісерфінг або серфінг на дошці, загальне'),
    'paSwimmingGeneral': MessageLookupByLibrary.simpleMessage('плавання'),
    'paSwimmingGeneralDesc': MessageLookupByLibrary.simpleMessage('плавання, помірні зусилля, загальне'),
    ...
    'paTrackField1Desc': MessageLookupByLibrary.simpleMessage('(наприклад, штовхання ядра, метання диска, метання молота)'),
    'paTrackField2Desc': MessageLookupByLibrary.simpleMessage('(наприклад, стрибки у висоту, стрибки в довжину, потрійний стрибок, метання списа, стрибки з жердиною)'),
    'paTrackField3Desc': MessageLookupByLibrary.simpleMessage('(наприклад, стипль-чез, біг з бар\'єрами)'),
    ...
    'paVolleyballGeneralDesc': MessageLookupByLibrary.simpleMessage('незмагальний, команда з 6 - 9 гравців, загальне'),
    ...
    'paWaterAerobicsDesc': MessageLookupByLibrary.simpleMessage('водна аеробіка, водна калістеніка'),
    ...
    'paWateraerobicsCalisthenicsDesc': MessageLookupByLibrary.simpleMessage('водна аеробіка, водна калістеніка'),
    'paWrestling': MessageLookupByLibrary.simpleMessage('боротьба'),
    'paWrestlingDesc': MessageLookupByLibrary.simpleMessage('загальне'),
    'palActiveDescriptionLabel': MessageLookupByLibrary.simpleMessage('Переважно стояча або ходьба на роботі і активний відпочинок'),
    'palActiveLabel': MessageLookupByLibrary.simpleMessage('Активний'),
    'palLowActiveDescriptionLabel': MessageLookupByLibrary.simpleMessage('наприклад, сидяча або стояча робота і легкі активності у вільний час'),
    'palLowLActiveLabel': MessageLookupByLibrary.simpleMessage('Малоактивний'),
    'palSedentaryDescriptionLabel': MessageLookupByLibrary.simpleMessage('наприклад, офісна робота і переважно сидячий відпочинок'),
    'palSedentaryLabel': MessageLookupByLibrary.simpleMessage('Сидячий спосіб життя'),
    'palVeryActiveDescriptionLabel': MessageLookupByLibrary.simpleMessage('Переважно ходьба, біг або носіння ваги на роботі і активний відпочинок'),
    ...
    'readLabel': MessageLookupByLibrary.simpleMessage('Я прочитав і приймаю політику конфіденційності.'),
    'recentlyAddedLabel': MessageLookupByLibrary.simpleMessage('Нещодавно'),
    'reportErrorDialogText': MessageLookupByLibrary.simpleMessage('Бажаєте повідомити про помилку розробнику?'),
    ...
    'sendAnonymousUserData': MessageLookupByLibrary.simpleMessage('Надсилати анонімні дані про використання'),
    'servingLabel': MessageLookupByLibrary.simpleMessage('Порція'),
    'servingSizeLabelImperial': MessageLookupByLibrary.simpleMessage('Розмір порції (унція/рідка унція)'),
    ...
    'settingsDisclaimerLabel': MessageLookupByLibrary.simpleMessage('Відмова від відповідальності'),
    'settingsDistanceLabel': MessageLookupByLibrary.simpleMessage('Відстань'),
    'settingsImperialLabel': MessageLookupByLibrary.simpleMessage('Імперська (фунти, фут, унції)'),
    ...
    'settingsPrivacySettings': MessageLookupByLibrary.simpleMessage('Налаштування конфіденційності'),
    ...
    'snackExample': MessageLookupByLibrary.simpleMessage('наприклад, яблуко, морозиво, шоколад ...'),
