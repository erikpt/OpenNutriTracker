...
void main() {
  group('MealNutrimentsEntity.fromFDCNutriments', () {
    ...
    test('energy falls back to Atwater General when 1008 absent', () {
      final entity = MealNutrimentsEntity.fromFDCNutriments([
    ...
    test('energy falls back to Atwater Specific when only that is present', () {
      final entity = MealNutrimentsEntity.fromFDCNutriments([
        _fdc(FDCConst.fdcKcalAtwaterSpecificId, 170),
      ]);
  ...
  group('MealNutrimentsEntity.fromOffNutriments', () {
    ...
    test('maps core macros correctly', () {
      final entity = MealNutrimentsEntity.fromOffNutriments(
          _dto(energyKcal: 200.0, carbs: 25.0, fat: 8.0, proteins: 12.0,
              sugars: 4.0, saturatedFat: 2.5, fiber: 3.0));
    ...
    test('handles integer values from OFF (dynamic type)', () {
      final entity = MealNutrimentsEntity.fromOffNutriments(
          _dto(energyKcal: 200, carbs: 25, fat: 8, proteins: 12,
              sugars: 4, saturatedFat: 2, fiber: 3));
    ...
    test('handles string values from OFF (dynamic type)', () {
      final entity = MealNutrimentsEntity.fromOffNutriments(
          _dto(energyKcal: '200', carbs: '25', fat: '8', proteins: '12',
              sugars: null, saturatedFat: null, fiber: null));
    ...
    test('maps all micronutrient fields correctly', () {
      final entity = MealNutrimentsEntity.fromOffNutriments(_dto(
        energyKcal: 0, carbs: 0, fat: 0, proteins: 0,
        sugars: 0, saturatedFat: 0, fiber: 0,
    ...
    test('absent micronutrients are null', () {
      final entity = MealNutrimentsEntity.fromOffNutriments(
          _dto(energyKcal: 100, carbs: 10, fat: 5, proteins: 5,
              sugars: 2, saturatedFat: 1, fiber: 1));
